...
if Plot_Parasite_Data == 1
    ...
    for n = 1:Count
        figure(299+n)
        labels = {sprintf('CDo_f = %.0f',CDo_f(n)*10000),sprintf('CDo_w = %.0f',CDo_w(n)*10000),sprintf('CDo_{h1} = %.0f',CDo_h1(n)*10000),sprintf('CDo_{v1} = %.0f',CDo_v1(n)*10000),sprintf('CDo_{v2} = %.0f',CDo_v2(n)*10000),sprintf('CDo_{misc} = %.0f',CDo_misc(n)*10000),sprintf('CDo_lp = %.0f',CDo_lp(n)*10000)};
